    ...
    try {
        switch (pkType) {
            ...
            case NP12: {
                ...
                auto offset = computeSntrupSharedSecret(pubKeyBytes, secretSntrup, msgType);
...
size_t
ZrtpDH::computeSntrupSharedSecret(uint8_t *pubKeyBytes, zrtp::SecureArray256 &secret, MessageType msgType) {
