...
void macSkein256(uint8_t const* key, uint64_t const keyLength, const uint8_t* data, uint64_t const dataLength,
                 zrtp::RetainedSecArray &macOut) {
    auto const hmac = std::make_unique<Botan::Skein_512>(256, "");
...
void macSkein256(uint8_t const* key, uint64_t keyLength,
