...
* 'configure.py --minimized-build --amalgamation --with-build-dir=android/arm64-v8a --os=android --cc=clang --cpu=arm64 --enable-modules=sha2_32,sha2_64,sha1,twofish,aes,skein,hmac,pubkey,curve25519,cfb,ec_group,ecdh,dh,dl_group'
*
* Target
*  - Compiler: /home/wdi/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm64
*  - OS: android
*/
