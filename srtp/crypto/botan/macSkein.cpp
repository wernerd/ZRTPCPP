...
void macSkein(const uint8_t *key, uint64_t const keyLength,
              const uint8_t *data, uint64_t const dataLength,
              uint8_t *mac, size_t macLength, int const skeinSize) {
    (void) skeinSize;
    auto const hmac = std::make_unique<Botan::Skein_512>(macLength, "");
...
void *createSkeinMacContext(const uint8_t *key, uint64_t const keyLength,
                            size_t macLength, int const skeinSize) {
    (void) skeinSize;
    auto *ctx = new macCtx;
...
void *initializeSkeinMacContext(void *ctx, const uint8_t *key, uint64_t const keyLength, size_t macLength,
                                int const skeinSize) {
    (void) skeinSize;
...
void macSkeinCtx(void *ctx, const uint8_t *data, uint64_t const dataLength, uint8_t *mac) {
